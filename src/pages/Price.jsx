...
import Content from '../components/ContentDashboard'
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 border-r-4 border-white overflow-y-auto bg-gray-900 px-6 pb-2 ring-1 ring-white/10">
                    <div className="flex h-16 shrink-0 items-center">
                      <img
                        className="h-8 w-auto"
                        src={Linken}
                        alt="Linken Dashboard"
                      />
                    </div>
              ...
              <ul className="flex flex-1 flex-col gap-y-7">
                ...
                <li>
                  ...
                  <ul  className="-mx-2 mt-2 space-y-1">
                    <Link className='group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold text-gray-400 hover:text-white hover:bg-gray-800' to='/price'><span className='flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 text-[0.625rem] font-medium text-gray-400 group-hover:text-white'>D</span>
                    <span className='truncate'>Desolator</span>
                    </Link>
                  </ul>
                </li>
